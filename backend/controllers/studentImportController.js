...
exports.importStudents = async (req, res) => {
  ...
  try {
    ...
    const headerMap = {
      ...
      "gender": "gender",
      "address": "address",
      "parent_na": "parent_name",
      "parent_name": "parent_name",
      "parent_ph": "parent_phone",
      "parent_phone": "parent_phone",
      "admission_": "admission_date",
      "admission_date": "admission_date",
      "academic_": "academic_year",
      "academic_year": "academic_year",
      "standard": "standard",
      "division": "division",
      "roll_numb": "roll_number",
      "roll_number": "roll_number",
      "passed": "passed",
      "percenta": "percentage",
      "percentage": "percentage",
      "fee_paid_i": "fee_paid_amount",
      "fee_paid_amount": "fee_paid_amount",
      "fee_paid_o": "fee_paid_on",
      "fee_paid_on": "fee_paid_on",
      "fee_clerk_id": "fee_clerk_id",
