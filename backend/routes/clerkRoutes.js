...
// --------- DEDICATED RETIREMENT ENDPOINTS (Independent, no dashboard dependency) ---------
// GET: List all teaching staff for retirement management
//   GET /api/clerk/retirement
//   Returns: { unit_id, staff: [{ staff_id, full_name, retirement_date }, ...] }
router.get('/retirement', authenticateToken, authorizeRoles('clerk'), getRetirementList);

// PUT: Update retirement date for a specific staff member
//   PUT /api/clerk/retirement
//   body: { staff_id, retirement_date (or null to clear) }
//   Returns: { success: true, staff: { staff_id, full_name, retirement_date } }
router.put('/retirement', authenticateToken, authorizeRoles('clerk'), updateRetirementDate);
